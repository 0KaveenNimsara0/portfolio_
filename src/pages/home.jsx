  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
       ...
       {/* Hero Section */}
        <section id="hero" className="pt-20 md:pt-16 min-h-screen flex items-center justify-center relative overflow-hidden bg-animated">
          {/* Decorative Elements */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 md:order-1 text-center md:text-left">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight" data-animate>
                  Hi, I'm <br />
                ...
                <div className="flex justify-center md:justify-start space-x-5" data-animate>
                  <a 
